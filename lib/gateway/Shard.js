            ...
            case "PRESENCE_UPDATE": {
                if (packet.d.user.username !== undefined) {
                    ...
                    if (!user || oldUser) {
                        ...
                        * @prop {String} oldUser.discriminator The discriminator of the user. If they've migrated to the new username system, this will be "0"                        * @prop {String?} oldUser.avatar The hash of the user's avatar, or null if no avatar
                        */
